<template>
  ...
  <div class="form-control">
    ...
    <textarea
      ...
      :placeholder="$t('mongo_other_options_placeholder')"
    ></textarea>
    <label class="label">
      <span class="label-text-alt">
        {{ $t('mongo_restore_options_tips') }}
        <a
          class="link-primary link"
          href="https://www.mongodb.com/docs/database-tools/mongorestore/"
          target="_blank"
          >https://www.mongodb.com/docs/database-tools/mongorestore/</a
        >
      </span>
    </label>
  </div>
